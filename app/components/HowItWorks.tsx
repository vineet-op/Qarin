        ...
        <div className="relative overflow-hidden rounded-xl">
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between rounded-lg bg-white p-4">
              ...
              <button className="rounded-md border border-neutral-200 bg-white px-4 py-1.5 font-inter text-[14px] font-medium text-neutral-600 transition-colors hover:bg-neutral-50">
                Connect
              </button>
            </div>
            ...
            <div className="flex items-center justify-between rounded-lg bg-white p-4">
              ...
              <button className="rounded-md bg-black px-4 py-1.5 font-inter text-[14px] font-medium text-white transition-colors hover:bg-neutral-800">
                Connect
              </button>
            </div>

            <div className="flex items-center justify-between rounded-lg bg-white p-4 opacity-50">
              <div className="flex items-center gap-3">
              ...
              <button className="rounded-md border border-neutral-200 bg-white px-4 py-1.5 font-inter text-[14px] font-medium text-neutral-600">
                Connect
              </button>
            </div>

            <div className="flex items-center justify-between rounded-lg bg-white p-4 opacity-30">
              <div className="flex items-center gap-3">
        ...
        <div className="space-y-4">
          <div className="rounded-xl bg-white p-4 ">
            <div className="mb-3 flex items-start justify-between">
              <div>
                ...
                <div
                  className="mt-1 font-inter text-[13px]"
              ...
              <div className="flex items-center gap-2">
                <div className="h-8 w-8 overflow-hidden rounded-full bg-neutral-200">
                  <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-blue-400 to-purple-500 font-inter text-[12px] font-semibold text-white">
                    AW
                  </div>
                </div>
              </div>
          ...
          <div className="rounded-xl bg-white p-4">
            <div className="mb-3 flex items-center gap-2">
              <span className="inline-flex items-center gap-1 rounded-full bg-blue-500 px-3 py-1 font-inter text-[12px] font-medium text-white">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
              ...
              <div className="ml-auto flex items-center gap-1 font-inter text-[13px] text-neutral-600">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="none"
            ...
            <div
              className="mb-2 font-sans text-[22px] font-semibold"
              style={{ color: "var(--heading-color)" }}
            >
              $251,000
            </div>
            <div
              className="mb-4 font-inter text-[13px]"
              style={{ color: "var(--subheading-color)" }}
            >
              Develop CRM Product
            </div>
            <div className="flex items-center gap-2">
              <div className="h-8 w-8 overflow-hidden rounded-full bg-neutral-200">
                <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-purple-400 to-pink-500 font-inter text-[12px] font-semibold text-white">
                  RB
                </div>
              </div>
              <div>
                ...
                <div className="font-inter text-[12px] text-neutral-500">
                  Sales Executive Manager
                </div>
              </div>
              <button className="ml-auto rounded p-1 hover:bg-neutral-100">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
    ...
    if (index === 2) {
      return (
        <div className="rounded-xl">
          ...
          <div className="relative mb-6 h-40 mt-10">
            <svg
              viewBox="0 0 368 166"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                <div
                  className="font-inter text-[11px] uppercase tracking-wide"
                  style={{ color: "var(--subheading-color)" }}
                >
                  Product
                </div>
    ...
    <section className="w-full bg-white px-4 py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-[1296px]">
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <h2
            className="font-sans text-[48px] font-medium leading-[1.1] tracking-tighter"
            style={{ color: "var(--heading-color)" }}
          >
          ...
          <p
            className="mx-auto mt-4 max-w-[620px] font-inter text-[16px] leading-relaxed"
            style={{ color: "var(--subheading-color)" }}
          >
        ...
        {/* Desktop Layout - Cards in grid, then text in grid */}
        <div className="hidden lg:block">
          <div className="grid grid-cols-3 gap-[23px]">
            {cardsData.map((card, index) => (
              <div key={card.id} style={{ width: "416px" }}>
                <article
          ...
          <div className="-mt-12 grid p-6 grid-cols-3 gap-[23px]">
            {cardsData.map((card) => (
              <div
                key={card.id}
